...
const (
	// Label holds the string label denoting the tempcodes type in the database.
	Label = "temp_codes"
...
// Columns holds all SQL columns for tempcodes fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
func ModeValidator(m Mode) error {
	...
	case ModeRegister, ModeReset:
		return nil
	default:
		return fmt.Errorf("tempcodes: invalid enum value for mode field: %q", m)
	}
}

// OrderOption defines the ordering options for the TempCodes queries.
