...
func (_u *UserIdentityUpdate) ClearProviderEmail() *UserIdentityUpdate {
...
func (_u *UserIdentityUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.ProviderEmailCleared() {
		_spec.ClearField(useridentity.FieldProviderEmail, field.TypeString)
	}
...
// ClearProviderEmail clears the value of the "provider_email" field.
func (_u *UserIdentityUpdateOne) ClearProviderEmail() *UserIdentityUpdateOne {
	_u.mutation.ClearProviderEmail()
	return _u
}
